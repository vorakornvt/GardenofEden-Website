  ...
  async findUser(email) {
    ...
    snapshot.forEach((doc) => {
      users.push({
        ...
        firstName: doc.data().firstName, // Ensure this field is included
        lastName: doc.data().lastName, // Ensure this field is included
        salutation: doc.data().salutation, // Ensure this field is included
